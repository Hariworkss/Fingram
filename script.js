...
function login(){
    HouseNum = iphouse.value; 
    loginPassword = ippass.value;
...
function getBal(balance){
    ...
    if(balance>2000){
        bal.innerHTML=`<h3 style=" color :white"> Your Savings is : <p style="padding-top:10px">Rs. ${balance}/-</p> </h3>`;
        alt.innerHTML =``;
    }
    else{
            bal.innerHTML=`<h3 style=" color:Yellow :"> Your Savings is : <p style="padding-top:10px">Rs. ${balance}/-</p> </h3>`;
